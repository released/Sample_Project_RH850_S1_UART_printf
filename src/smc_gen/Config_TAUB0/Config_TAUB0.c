...
void R_Config_TAUB0_Create(void)
{
    ...
    TAUB0.TT |= (_TAUB_CHANNEL2_COUNTER_STOP | _TAUB_CHANNEL1_COUNTER_STOP | _TAUB_CHANNEL0_COUNTER_STOP);
...
void R_Config_TAUB0_Start(void)
{
    ...
    TAUB0.TS |= (_TAUB_CHANNEL2_COUNTER_START | _TAUB_CHANNEL1_COUNTER_START | _TAUB_CHANNEL0_COUNTER_START);
}
