...
#define _TAUB0_CHANNEL1_COMPARE_VALUE                              (0x000CU) /* Data register for compare values */
#define _TAUB0_CHANNEL2_COMPARE_VALUE                              (0x0006U) /* Data register for compare values */
