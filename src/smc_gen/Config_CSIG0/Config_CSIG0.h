...
Macro definitions
***********************************************************************************************************************/
#define _CSIG0_MASTER_PCLK_DIV                         (0xA000U) /* Selects the basic clock */
#define _CSIG0_BAUD_RATE                               (0x007DU) /* baudrate set */
#define _CSIG0_SETTING_INIT                            (0x00000000UL) /* Transmit setting init value */
