...
volatile uint16_t  g_csig0_total_num;                      /* csig0 transmit/receive data total times */
/* Start user code for global. Do not edit comment generated here */
/* End user code. Do not edit comment generated here */

/***********************************************************************************************************************
* Function Name: R_Config_CSIG0_Create
* Description  : This function initializes the Config_CSIG0 module.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
void R_Config_CSIG0_Create(void)
{
    ...
    CSIG0.CTL2 = _CSIG0_MASTER_PCLK_DIV | _CSIG0_BAUD_RATE;
    ...
    PORT.PDSC10 = (tmp_port & _PORT_CLEAR_BIT7);
    PORT.PDSC10 = (uint32_t) ~(tmp_port & _PORT_CLEAR_BIT7);
    PORT.PDSC10 = (tmp_port & _PORT_CLEAR_BIT7);
    ...
    tmp_port = PORT.PDSC10;
    PORT.PPCMD10 = _WRITE_PROTECT_COMMAND;
    PORT.PDSC10 = (tmp_port & _PORT_CLEAR_BIT6);
    PORT.PDSC10 = (uint32_t) ~(tmp_port & _PORT_CLEAR_BIT6);
    PORT.PDSC10 = (tmp_port & _PORT_CLEAR_BIT6);
...
* Description  : This function starts the CSIG0 module operation.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
void R_Config_CSIG0_Start(void)
{
    ...
    CSIG0.CTL0 = _CSIG_OPERATION_CLOCK_PROVIDE | _CSIG_TRANSMISSION_PERMIT | _CSIG_RECEPTION_PERMIT | 
                 _CSIG_DIRECTACCESS;
...
* Description  : This function stops the CSIG0 module operation.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
...
/***********************************************************************************************************************
* Function Name: R_Config_CSIG0_Send_Receive
* Description  : This function sends and receives csig0 data.
* Arguments    : tx_buf -
*                    send buffer pointer
*                tx_num -
*                    buffer size
...
***********************************************************************************************************************/
MD_STATUS R_Config_CSIG0_Send_Receive(uint16_t* const tx_buf, uint16_t tx_num, uint16_t* const rx_buf)
{
    MD_STATUS status = MD_OK;
    uint32_t regValue = _CSIG0_SETTING_INIT;
    ...
    else
    {
        ...
        gp_csig0_tx_address = tx_buf;
        g_csig0_total_num = tx_num;
        g_csig0_tx_num = 0U;
        /* Set receive setting */
